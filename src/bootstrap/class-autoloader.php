<?php
/**
 * MediaPress autoload Implementation.
 *
 * @package    MediaPress
...
/**
 * Auto Loader for MediaPress.
 *
 * After registering this autoload function with SPL, the following line
 * would cause the function to attempt to load the PressThemes\MediaPress\Bar\Baz\Qux class
 * from /path/to/wp-content/plugins/mediapress/src/bar/baz/class-qux.php:
 *
 *      new PressThemes\MediaPress\Baz_Xyz\Qux;
 *  maps to /path/to/wp-content/plugins/mediapress/src/bar/baz-xyz/class-qux.php
 * The path/directory name should be all lowercase and the the class file is named as 'class-$classname.php'
 */
class Autoloader {

	/**
	 * Namespace root. eg. PressThemes\\MediaPress\\(escaped slashes);
	 *
	 * @var string
	 */
